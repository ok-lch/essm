...
class BaseDocumenter(ClassDocumenter):
    ...
    def can_document_member(cls, member, membername, isattr, parent):
        return isinstance(member, (BaseEquation, BaseVariable)) and hasattr(
            member, "definition"
        )
...
with open(
    ...
    pyproject_file = toml.load(fp)
    version = pyproject_file["project"]["version"]
    # exec(fp.read(), g)
...
html_theme_options = {
    "logo": "logo.png",
    "logo_name": False,
    "description": "Python package for dealing with physical variables and units.",
...
latex_documents = [
    (master_doc, "ESSM.tex", "ESSM Documentation", "Stan Schymanski", "manual"),
]
...
autodoc_default_options = {"undoc-members": True, "show-inheritance": True}
